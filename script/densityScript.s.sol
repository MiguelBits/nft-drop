...
contract DensityScript is Script {
using stdJson for string;
    ...
    function _mint(address nft_contract, string memory _path) public {
        ...
        uint256 completeJSON = 14075; //TODO

        uint256 users_length = 800; //TODO

        uint256 json_lastCount = 8808 + users_length * 3;  //TODO

        console.log("json_lastCount: ", completeJSON - json_lastCount);

        uint256 last_onChain_index_minted = 568; //TODO
        ...
        for (uint index = json_lastCount; index <= json_lastCount + users_length; index++) {
